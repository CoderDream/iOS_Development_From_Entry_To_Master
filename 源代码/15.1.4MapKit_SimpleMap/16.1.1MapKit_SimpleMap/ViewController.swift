...
class ViewController: UIViewController, MKMapViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        //缩放
//        map.region.span.latitudeDelta *= 1.5
//        map.region.span.longitudeDelta *= 1.5
        
        //平移
//        let coordinate = map.convert(CGPoint(x:map.frame.size.width/2, y:0), toCoordinateFrom: map)
