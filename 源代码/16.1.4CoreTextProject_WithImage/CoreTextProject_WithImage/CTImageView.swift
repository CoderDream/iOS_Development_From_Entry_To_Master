...
class CTImageView: UIView {
    ...
    override func draw(_ rect: CGRect) {
        ...
        placeHolder.addAttribute(kCTRunDelegateAttributeName as String, value: ctRunDelegate!, range: NSMakeRange(0, 1))
        placeHolder.addAttribute("pictureName", value: picture, range: NSMakeRange(0, 1))
        ...
        attributedStr.addAttribute(kCTUnderlineStyleAttributeName as String, value: NSNumber(value: 1), range: NSRange(location: 0, length: attributedStr.length))
