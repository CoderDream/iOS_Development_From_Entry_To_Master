...
class ViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    var comments = [
        ["1.Nebraska这个梗是这样的，当年美国很多公司的呼叫中心设在nebraska（原因有两说，一说是战略空军司令部在这，所以电话线路多，一说是中西部的人说话口音比较标准. 我没考证过哪个对，或者是两个都有），那时候AT&T 店大欺客，800只能打长途不能打市话. 所以八十年代各种广告后面附的电话都是除Nebraska以外，然后后面应该还有一个Nebraska专用的号码.","2.鲍尔默一直都是这种画风……","3.见多了我们的cheer leader的表演就不见怪了。内部company meeting上的那些你们没见过，还有billg出演的。还有个嘲讽非windows系统的广告，好像是和Brian Valentine一起演的，那货也是个怪咖，以前Windows的SVP。"],
        ["1.它真的黑，黑出亮。","2.在天朝，购买它所缴纳的消费税可以买一台超级本","3.这家能够操作供应链的公司，想要什么样的显卡、什么样的内存、什么样的SSD都能信手拈来；这够黑吧"],
        ["1.据巴宝莉新闻稿了解，Apple TV 在直播过程中将推出购物功能，观众能直接预定秀场上出现的服装。这么看来，这个功能用在国内简直是一大引入点，可以在春晚直播的过程中购买明星同款。","2.这次怎么不用iPhone®拍摄b？"]]
